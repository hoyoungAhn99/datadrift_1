...
class PyCILPODNet(nn.Module):
    """PyCIL ``CosineIncrementalNet`` specialized for CIFAR PODNet."""

    def __init__(self, num_classes: int, *, proxies_per_class: int = 10) -> None:
        super().__init__()
        self.backbone: CifarResNet = resnet32()
