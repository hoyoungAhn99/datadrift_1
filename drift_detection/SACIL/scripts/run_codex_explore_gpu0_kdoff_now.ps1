...
$QueueLog = Join-Path $ProjectRoot "outputs\runner_logs\codex_explore_gpu0_kdoff_queue.log"
...
Write-QueueLog "GPU0 KD-off queue initialized"
...
Write-QueueLog "GPU0 KD-off queue finished"
