...
except ImportError:  # pragma: no cover - optional for cached-feature inference
    transforms = None
    datasets = None
...
_ImageFolderBase = datasets.ImageFolder if datasets is not None else object


class SubsetImageFolder(_ImageFolderBase):
    ...
    def __init__(self,
        ...
        if datasets is None:
            raise ImportError("torchvision is required to build image datasets.")
