...
def MS_loss(features, path_labels, alpha=2.0, beta=50.0, lam=0.5, mining_margin=0.1):
    ...
    if path_labels.dim() == 1:
        mask_pos = path_labels.unsqueeze(1) == path_labels.unsqueeze(0)
    else:
        label_comparison = path_labels.unsqueeze(1) == path_labels.unsqueeze(0)
    ...
    for i in range(batch_size):
        ...
        neg_sim_i = neg_sim_i[neg_sim_i + mining_margin > hardest_pos_sim] 
        pos_sim_i = pos_sim_i[pos_sim_i - mining_margin < hardest_neg_sim]
