...
class VehicleDataset(Dataset):
    def __init__(self, metadata, image_path,
                 type_to_idx, make_to_idx, model_to_idx, year_to_idx, all_labels_to_idx, flip_p=0.0):
...
class VehicleDataModule(pl.LightningDataModule):
    def __init__(self, json_paths, image_path, batch_size=64, num_workers=4, seed=42, flip_p=0.5, cache_filename="metadata_cache.pkl"):
        super().__init__()
    ...
    def setup(self, stage=None):
        cache_path = self.json_paths / self.cache_filename
